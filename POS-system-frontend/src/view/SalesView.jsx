      ...
      <div className="flex flex-col sm:flex-row items-center gap-8 flex-1 justify-center">
        <div className="relative w-40 h-40 shrink-0">
          <svg viewBox="0 0 100 100" className="transform -rotate-90 w-full h-full">
            ...
            <circle cx="50" cy="50" r="40" fill="none" stroke="#10B981" strokeWidth="20" strokeDasharray="163.36 251.2" className="transition-all duration-1000 ease-out" /> {/* 65% */}
            <circle cx="50" cy="50" r="40" fill="none" stroke="#3B82F6" strokeWidth="20" strokeDasharray="62.8 251.2" strokeDashoffset="-163.36" className="transition-all duration-1000 ease-out" /> {/* 25% */}
            <circle cx="50" cy="50" r="40" fill="none" stroke="#F59E0B" strokeWidth="20" strokeDasharray="25.12 251.2" strokeDashoffset="-226.16" className="transition-all duration-1000 ease-out" /> {/* 10% */}
          </svg>
...
const RecentSalesTable = () => {
  const sales = [
    { id: "#ORD-8852", date: "Today, 10:42 AM", customer: "Rohan Mehta", cashier: "Rahul Sharma", amount: 1250, method: "UPI", status: "Completed" },
    { id: "#ORD-8851", date: "Today, 10:38 AM", customer: "Sita Verma", cashier: "Priya Patel", amount: 450, method: "Cash", status: "Completed" },
    { id: "#ORD-8850", date: "Today, 10:35 AM", customer: "Amit Singh", cashier: "Rahul Sharma", amount: 2800, method: "Card", status: "Refunded" },
    { id: "#ORD-8849", date: "Today, 10:30 AM", customer: "Priya Shah", cashier: "Sneha Gupta", amount: 920, method: "UPI", status: "Completed" },
    { id: "#ORD-8848", date: "Today, 10:25 AM", customer: "Vikram Das", cashier: "Amit Kumar", amount: 150, method: "Cash", status: "Completed" },
  ];
