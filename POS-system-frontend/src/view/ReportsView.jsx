        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex gap-3">
                    ...
                    <button onClick={handleGlobalExport} className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="flex justify-between items-center mb-8">
                ...
                <button onClick={handleExport} className="flex items-center gap-2 px-3 py-1.5 border border-gray-200 dark:border-gray-700 rounded-lg text-xs font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
            ...
            <div className="flex gap-4 h-64">
                ...
                {/* Chart Area */}
                <div className="flex-1 flex items-end justify-between pb-6 border-b border-gray-100 dark:border-gray-700 relative">
                    {/* Horizontal Grid Lines */}
                    {yLabels.map((_, i) => (
                        <div key={i} className="absolute w-full border-t border-dashed border-gray-100 dark:border-gray-700/50" style={{ bottom: `${(4 - i) * 25}%`, left: 0, zIndex: 0 }}></div>
                    ))}
                    ...
                    {data.map((item, i) => {
                        ...
                        return (
                            <div key={i} className="flex flex-col items-center justify-end h-full w-full gap-2 z-10 group relative">
                                ...
                                <span className="absolute -bottom-6 text-[10px] sm:text-xs text-gray-400 whitespace-nowrap">{item.date}</span>
                            </div>
                        );
                    })}
                </div>
...
// Icons reuse
const Calendar = (props) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="18" height="18" x="3" y="4" rx="2" ry="2" /><line x1="16" x2="16" y1="2" y2="6" /><line x1="8" x2="8" y1="2" y2="6" /><line x1="3" x2="21" y1="10" y2="10" /></svg>;
...
const BarChart2 = (props) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="18" x2="18" y1="20" y2="10" /><line x1="12" x2="12" y1="20" y2="4" /><line x1="6" x2="6" y1="20" y2="14" /></svg>;
                ...
                {data.map((item, index) => (
                    <div key={index} className="space-y-2">
                        <div className="flex justify-between text-sm">
                            ...
                            <span className="font-bold text-gray-900 dark:text-white">₹{item.sales.toLocaleString()} <span className="text-xs font-normal text-gray-500">({item.percentage}%)</span></span>
                        </div>
                        ...
                        <div className="flex-1 space-y-2">
                            <div className="flex justify-between text-sm">
                                ...
                                <div className="text-right">
                                    ...
                                    <span className={`text-xs font-medium ${item.efficiency >= 90 ? 'text-green-500' : item.efficiency >= 80 ? 'text-blue-500' : 'text-yellow-500'}`}>
